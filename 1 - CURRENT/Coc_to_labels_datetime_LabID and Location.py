...
if __name__=='__main__':
    try:
        ...
        for sheet in CoC.sheet_names:
            ...
            project_name = project_info['Project Name: '].ix[0]
            project_number = project_info['Project Number:'].ix[0]
            ...
            for row in form.iterrows():
                ...
                try:
                    number_of_name = info[['No. of' in s for s in info.index]].index[0] #maybe No. of containers?
                    no_of_bottles = int(info[number_of_name])
                except:
                    no_of_bottles = 0
